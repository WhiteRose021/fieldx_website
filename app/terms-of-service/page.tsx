      ...
      <div className="min-h-screen bg-black text-white overflow-x-hidden">
        ...
        <section className="pt-32 pb-24 bg-black">
          <div className="container mx-auto px-6">
            ...
            >
              <h1 className="text-4xl md:text-5xl font-light mb-8 text-center text-white">Terms of Service</h1>
              ...
              >
                ...
                <motion.div variants={fadeInUp} className="bg-gray-900/50 backdrop-blur-sm border border-gray-800 rounded-xl p-6 hover:border-blue-500/30 transition-colors duration-300">
                  <h2 className="text-2xl font-light mb-4 text-white">1. Use of the Website</h2>
                  <p className="mb-4">
                    By accessing www.fieldx.gr, you agree to use the site only for lawful purposes and in accordance with these Terms of Service.
                  </p>
                </motion.div>

                <motion.div variants={fadeInUp} className="bg-gray-900/50 backdrop-blur-sm border border-gray-800 rounded-xl p-6 hover:border-blue-500/30 transition-colors duration-300">
                  <h2 className="text-2xl font-light mb-4 text-white">2. Intellectual Property</h2>
                  <p className="mb-4">
                    All content on this website, including text, graphics, logos, and software, is the property of FieldX and protected by intellectual property laws.
                  </p>
                </motion.div>

                <motion.div variants={fadeInUp} className="bg-gray-900/50 backdrop-blur-sm border border-gray-800 rounded-xl p-6 hover:border-blue-500/30 transition-colors duration-300">
                  <h2 className="text-2xl font-light mb-4 text-white">3. Limitation of Liability</h2>
                  <p className="mb-4">
                    FieldX is not liable for any damages arising from the use or inability to use the website or its content.
                  </p>
                </motion.div>

                <motion.div variants={fadeInUp} className="bg-gray-900/50 backdrop-blur-sm border border-gray-800 rounded-xl p-6 hover:border-blue-500/30 transition-colors duration-300">
                  <h2 className="text-2xl font-light mb-4 text-white">4. Changes to Terms</h2>
                  <p className="mb-4">
                ...
                <motion.div variants={fadeInUp} className="bg-gray-900/50 backdrop-blur-sm border border-gray-800 rounded-xl p-6 hover:border-blue-500/30 transition-colors duration-300">
                  ...
                  <p>
                    If you have any questions about these Terms, contact us at <strong>info@fieldx.gr</strong>.
                  </p>
                </motion.div>
              </motion.div>
            </motion.div>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-8 max-w-4xl mx-auto mb-12">
              ...
              <div className="text-center">
                ...
                <ul className="space-y-2 text-gray-400 text-sm">
                  ...
                  <motion.li whileHover={{ y: -2 }} className="flex justify-center">
                    <Link href="/terms" className="hover:text-blue-400 transition-colors font-medium text-blue-400">
                      Terms of Service
                    </Link>
                  </motion.li>
                </ul>
